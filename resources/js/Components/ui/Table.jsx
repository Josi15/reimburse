...
export function TR({ children, className, ...props }) {
    return (
        <tr className={cn('hover:bg-gray-50 dark:hover:bg-gray-700/40', className)} {...props}>
            {children}
        </tr>
    );
}
...
export function TD({ children, className }) {
    return <td className={cn('px-4 py-3 text-sm text-gray-700 dark:text-gray-200', className)}>{children}</td>;
}
